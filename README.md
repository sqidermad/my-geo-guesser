...
# Technologies Used
This project is being built using Next.js, TypeScript, and Styled-Components for the front-end development. Additionally, Leaflet library is used for the map display. I am also using my own footage for the videos.
